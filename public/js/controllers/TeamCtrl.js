angular.module('TeamCtrl', []).controller('TeamController', function($scope) {
	...
	$scope.head1='Amanda Nguyen';
	$scope.head2='Mei Lin Chen';
	$scope.head3='Dave Nidumolu';
	$scope.head4="Daniel D'Cruz";
	$scope.head5='Arka Ganguli';
	$scope.head6='Dillon Mulcahy';
  ...
  $scope.info3 = 'Co-Vice President';
 	$scope.info4 = 'VP Strategic Relations';
	$scope.info5 = 'VP Technical';
  $scope.info6 = 'VP Events';
  $scope.info8 = 'VP Marketing';
